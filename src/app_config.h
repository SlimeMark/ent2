...
struct AppConfig {
  ...
  static constexpr uint32_t SILENCE_TIMEOUT_MS = 650;
  static constexpr uint32_t MIN_RECORDING_MS = 300;
  ...
  static constexpr size_t MAX_RECORDING_SECONDS = 12;
  static constexpr size_t MAX_RECORDING_SAMPLES =
      AUDIO_SAMPLE_RATE * MAX_RECORDING_SECONDS;

  // Tune this threshold for the actual microphone gain and room noise floor.
  ...
  static constexpr uint32_t RMS_LOG_INTERVAL_MS = 500;
